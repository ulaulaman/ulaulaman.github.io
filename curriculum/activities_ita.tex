...
I plugin specifici per EduINAF sono, invece, caricati su alcuni repository presenti su GitHub. In particolare:
...
Parte del codice è, inoltre, personalizzato utilizzando il plugin Code Snippet. Parte di questo codice si trova, come backup, su un \href{https://github.com/ulaulaman/eduinafbackupcode}{apposito repository}.
%
